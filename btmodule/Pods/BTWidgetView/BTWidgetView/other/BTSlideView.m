...
@interface BTSlideView()<UIGestureRecognizerDelegate>
...
- (BOOL)isPointInChildView:(CGPoint)point{
    if (self.style == BTSlideStyleLeft && point.x < self.slideView.BTRight) {
        return YES;
    }
    
    if (self.style == BTSlideStyleRight && point.x > self.slideView.BTLeft) {
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer{
    if (gestureRecognizer == self.tap && [self isPointInChildView:[gestureRecognizer locationInView:self]]) {
        
        return NO;
    }
    
//    if (gestureRecognizer == self.pan && [self isPointInChildView:[gestureRecognizer locationInView:self]]) {
//
//        return YES;
//    }
