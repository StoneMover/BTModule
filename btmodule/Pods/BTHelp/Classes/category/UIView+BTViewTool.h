...
#pragma mark 圆角相关处理
@property (nonatomic, assign) IBInspectable CGFloat BTCorner;
    
@property (nonatomic, assign) IBInspectable CGFloat BTBorderWidth;
    
@property (nonatomic, strong) IBInspectable UIColor * BTBorderColor;
