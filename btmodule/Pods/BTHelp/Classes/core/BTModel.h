...
/**
 解析250行json，1000条数据，且处理model中的各种计算，iPhone11

 未优化：1.5164828300476074
 去掉Log：1.4232802391052246
 去掉Log+优化空值判断：1.3588242530822754
 去掉Log+优化空值判断+缓存：1.2818849086761475

 YYModel：1.0551021099090576


 ————————————————————————————————————
 解析250行json，1000条数据，iPhone11
 BTModel： 0.2926750183105469
 YYModel:  0.08014512062072754
