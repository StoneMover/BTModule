...
+ (void)openSetVc{
    [self toUrlPage:UIApplicationOpenSettingsURLString];
}

+ (void)toAppstorePage:(NSString*)appid{
    [self toUrlPage:[NSString stringWithFormat:@"itms-apps://itunes.apple.com/app/id%@",appid]];
}

+ (void)toCallPhone:(NSString*)phone{
    [self toUrlPage:[NSString stringWithFormat:@"tel://%@",phone]];
}
